...
$response = $this->context->getResponse();
  ...
  $response->addMeta('title', 'Labs', false, false);
  $response->addMeta('language', 'fr', false, false);

  $response->addStylesheet('main.css', '', array ());
  $response->addStylesheet('sfadmin.css', '', array ());
  ...
  $response->addJavascript('jquery/validate-extended.js', '', array ());
